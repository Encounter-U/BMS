 ...
 * Generated at: 2024-03-30 06:30:35 UTC
...
public final class admin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<style>\n");
      out.write("body {\n");
      out.write("\tbackground-image: url(\"imgs/01.jpg\");\n");
      out.write("}\n");
      out.write("</style>\n");
      out.write("</head>\n");
      out.write("\n");
...
out.write(admin.getName());
      ...
      out.write("\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>根据图书名称、作者、分类查询图书基本信息</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>添加、修改或删除图书信息</li>\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"bootstrap-admin-panel-content\">\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>根据账号、姓名、ID查询读者基本信息</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>添加、修改或删除读者信息</li>\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\t<div class=\"bootstrap-admin-panel-content\">\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>查看图书分类信息，显示分类ID</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>添加、修改或删除图书分类</li>\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"panel panel-default\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"text-muted bootstrap-admin-box-title\">图书借阅信息</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"bootstrap-admin-panel-content\">\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>展示所有正在借阅的图书信息与读者信息</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>可以实现还书与延期功能</li>\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"panel panel-default\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"text-muted bootstrap-admin-box-title\">图书归还信息</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"bootstrap-admin-panel-content\">\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>展示所有已归还的图书的信息</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>记录图书出馆时间与归馆时间</li>\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t<div class=\"panel panel-default\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"panel-heading\">\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"text-muted bootstrap-admin-box-title\">管理员管理(需登录)</div>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"bootstrap-admin-panel-content\">\n");
      out.write("\t\t\t\t\t\t\t\t<ul>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>仅最高管理员可以访问本页面</li>\n");
      out.write("\t\t\t\t\t\t\t\t\t<li>添加、修改或删除管理员信息</li>\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t\t\t\ttype=\"hidden\" name=\"url\" value=\"admin\">\n");
